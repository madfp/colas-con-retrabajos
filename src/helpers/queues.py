...
class Service():
    def __init__(self, env, num_servers, time_service, time_interval):
        self.env = env
    ...
    def getStats(self):
        return [self.attended_clients, self.reworked_clients]
...
class Simulation:
    ...
    def useService(self, addItem, client, service):
        ...
        service.resource.release(request)
    ...
    def run_service(self, addItem, num_servers, time_service, time_interval):
        service = Service(self.env, num_servers, time_service, time_interval)
        while True:
